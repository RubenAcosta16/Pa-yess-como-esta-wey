 ...
 * @author ACER A314
 */
public class Crear_Alm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(btnCrear, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 100, -1));
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        try {
            ...
            ingredientes.agregarIngrediente(new Ingrediente(plId, textNombre.getText(), textUnidadMedida.getText(), precioDouble, textPuntoReorden.getText() , textProveedor.getText(),cantidadInt));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Crear_Alm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
