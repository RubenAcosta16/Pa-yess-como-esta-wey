 ...
 * @author ACER A314
 */
public class Editar_Platillo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textIdBuscar = new Otros.FocoBtn();
        ...
        jLabel1.setText("Editar PLATILLO");
        jPanel2.add(jLabel1);
        ...
        jPanel3.add(btnCargar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 100, -1));
        ...
        jPanel3.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 270, 130, -1));

        textIdBuscar.setText("idPlatillo");
        textIdBuscar.setCambiarColor(true);
        textIdBuscar.setFont(new java.awt.Font("Franklin Gothic Heavy", 1, 18)); // NOI18N
        textIdBuscar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textIdBuscarActionPerformed(evt);
            }
        });
        jPanel3.add(textIdBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, -1, -1));
    ...
    private void btnActualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnActualizarMouseClicked
        ...
        try {
            ...
            int idInt = Integer.parseInt(textIdBuscar.getText());
    ...
    private void btnCargarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCargarMouseClicked
        ...
        try {
            ...
            if (platilloBuscado == null) {
                ...
                textNombre.setText(platilloBuscado.getNombre());
                textDescripcion.setText(platilloBuscado.getDescripcion());
                textPrecio.setText(platilloBuscado.getPrecio() + "");
            }
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Editar_Platillo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Editar_Platillo().setVisible(true);
            }
        });
    }
    ...
    private Otros.FocoBtn textIdBuscar;
